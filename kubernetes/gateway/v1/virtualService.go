...
func NewVirtualService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.solo.io/v1:VirtualService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualService(ctx *pulumi.Context,
	...
	var resource VirtualService
	err := ctx.ReadResource("kubernetes:gateway.solo.io/v1:VirtualService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
