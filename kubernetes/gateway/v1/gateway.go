...
func NewGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:gateway.solo.io/v1:Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGateway(ctx *pulumi.Context,
	...
	var resource Gateway
	err := ctx.ReadResource("kubernetes:gateway.solo.io/v1:Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
